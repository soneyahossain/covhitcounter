...
public class TestYears { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_years_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_yearsBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_yearsBetween_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_yearsIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseYears_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
