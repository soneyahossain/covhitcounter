...
public class TestDateTimeComparator { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testStaticGetInstance();
        TB.tearDown();
        TB.setUp();
        TB.testStaticGetDateOnlyInstance();
        TB.tearDown();
        TB.setUp();
        TB.testStaticGetTimeOnlyInstance();
        TB.tearDown();
        TB.setUp();
        TB.testStaticGetInstanceLower();
        TB.tearDown();
        TB.setUp();
        TB.testStaticGetInstanceLowerUpper();
        TB.tearDown();
        TB.setUp();
        TB.testNullNowCheckedOnce();
        TB.tearDown();
        TB.setUp();
