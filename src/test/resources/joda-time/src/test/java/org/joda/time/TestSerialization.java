...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testSerializedInstant();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateTime();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateTimeProperty();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedMutableDateTime();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedMutableDateTimeProperty();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateMidnight();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateMidnightProperty();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedLocalDate();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedLocalDateBuddhist();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedLocalTime();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedLocalDateTime();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedYearMonthDay();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedTimeOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateTimeZoneUTC();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateTimeZone();
        TB.tearDown();
        TB.setUp();
        TB.testDuration();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedCopticChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedISOChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedGJChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedGJChronologyChangedInternals();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedGregorianChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedJulianChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedBuddhistChronology();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedPeriodType();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedDateTimeFieldType();
        TB.tearDown();
        TB.setUp();
        TB.testSerializedUnsupportedDateTimeField();
        TB.tearDown();
