...
public class TestTimeOfDay_Properties { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddHour();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddNoWrapHour();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldHour();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddMinute();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddNoWrapMinute();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldMinute();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddSecond();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddNoWrapSecond();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldSecond();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddMilli();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddNoWrapMilli();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldMilli();
        TB.tearDown();
        TB.setUp();
