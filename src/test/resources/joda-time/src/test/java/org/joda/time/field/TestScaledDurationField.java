...
public class TestScaledDurationField { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_getUnitMillis();
        TB.tearDown();
        TB.setUp();
        TB.test_toString();
        TB.tearDown();
        TB.setUp();
        TB.test_getValue_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getValueAsLong_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getValue_long_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getValueAsLong_long_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getMillis_int();
        TB.tearDown();
        TB.setUp();
        TB.test_getMillis_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getMillis_int_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getMillis_long_long();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_getDifference_long_int();
        TB.tearDown();
        TB.setUp();
