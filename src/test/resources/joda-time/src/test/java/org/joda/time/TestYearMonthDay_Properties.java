...
public class TestYearMonthDay_Properties { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddMonth();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldMonth();
        TB.tearDown();
        TB.setUp();
        TB.testPropertySetMonth();
        TB.tearDown();
        TB.setUp();
        TB.testPropertySetTextMonth();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddDay();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldDay();
        TB.tearDown();
        TB.setUp();
        TB.testPropertySetDay();
        TB.tearDown();
        TB.setUp();
        TB.testPropertySetTextDay();
        TB.tearDown();
        TB.setUp();
