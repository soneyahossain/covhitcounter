...
public class TestISOPeriodFormat { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFormatStandard();
        TB.tearDown();
        TB.setUp();
        TB.testFormatStandard_negative();
        TB.tearDown();
        TB.setUp();
        TB.testFormatAlternate();
        TB.tearDown();
        TB.setUp();
        TB.testFormatAlternateExtended();
        TB.tearDown();
        TB.setUp();
        TB.testFormatAlternateWithWeeks();
        TB.tearDown();
        TB.setUp();
        TB.testFormatAlternateExtendedWithWeeks();
        TB.tearDown();
