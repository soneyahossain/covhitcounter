...
public class TestDuration_Constructors { //extends TestCase {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardDays_long();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardHours_long();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardMinutes_long();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardSeconds_long();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_millis_long();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Overflow1();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Overflow2();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Overflow3();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Overflow4();
        TB.tearDown();
