...
public class TestDateMidnight_Properties { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPropertySetTextLocaleMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddLongMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyAddWrapFieldMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyGetDifferenceMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRoundFloorMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRoundCeilingMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRoundHalfFloorMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRoundHalfCeilingMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRoundHalfEvenMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testPropertyRemainderMonthOfYear();
        TB.tearDown();
        TB.setUp();
