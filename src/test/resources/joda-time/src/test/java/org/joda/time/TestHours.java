...
public class TestHours { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_hours_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_hoursBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_hoursBetween_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_hoursIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardHoursIn_RPeriod();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseHours_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
