...
public class TestDateTimeFieldType { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_centuryOfEra();
        TB.tearDown();
        TB.setUp();
        TB.test_yearOfCentury();
        TB.tearDown();
        TB.setUp();
        TB.test_yearOfEra();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_weekyearOfCentury();
        TB.tearDown();
        TB.setUp();
        TB.test_weekyear();
        TB.tearDown();
        TB.setUp();
        TB.test_weekOfWeekyear();
        TB.tearDown();
        TB.setUp();
        TB.test_dayOfYear();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_halfdayOfDay();
        TB.tearDown();
        TB.setUp();
        TB.test_clockhourOfDay();
        TB.tearDown();
        TB.setUp();
        TB.test_clockhourOfHalfday();
        TB.tearDown();
        TB.setUp();
        TB.test_hourOfHalfday();
        TB.tearDown();
        TB.setUp();
        TB.test_hourOfDay();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_minuteOfHour();
        TB.tearDown();
        TB.setUp();
        TB.test_secondOfDay();
        TB.tearDown();
        TB.setUp();
        TB.test_secondOfMinute();
        TB.tearDown();
        TB.setUp();
        TB.test_millisOfDay();
        TB.tearDown();
        TB.setUp();
        TB.test_millisOfSecond();
        TB.tearDown();
