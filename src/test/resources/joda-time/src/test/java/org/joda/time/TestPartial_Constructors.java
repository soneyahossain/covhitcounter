...
public class TestPartial_Constructors { //extends TestCase {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Chrono();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Type_int();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx1_Type_int();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx2_Type_int();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Type_int_Chrono();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx_Type_int_Chrono();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx2_Type_int_Chrono();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_TypeArray_intArray_year_weekyear();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor2_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx1_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx3_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx5_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx6_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx7_TypeArray_intArray_inOrder();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx8_TypeArray_intArray_duplicate();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx9_TypeArray_intArray();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_TypeArray_intArray_Chrono();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_Partial();
        TB.tearDown();
        TB.setUp();
        TB.testConstructorEx_Partial();
        TB.tearDown();
    }
