...
public class TestUnsupportedDateTimeField {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.setUp();
        TB.testNullValuesToGetInstanceThrowsException();
        TB.tearDown();
        TB.setUp();
        TB.testDifferentDurationReturnDifferentObjects();
        TB.tearDown();
        TB.setUp();
        TB.testPublicGetNameMethod();
        TB.tearDown();
        TB.setUp();
        TB.testAlwaysFalseReturnTypes();
        TB.tearDown();
        TB.setUp();
        TB.testMethodsThatShouldAlwaysReturnNull();
        TB.tearDown();
        TB.setUp();
        TB.testUnsupportedMethods();
        TB.tearDown();
        TB.setUp();
        TB.testDelegatedMethods();
        TB.tearDown();
        TB.setUp();
        TB.testToString();
        TB.tearDown();
