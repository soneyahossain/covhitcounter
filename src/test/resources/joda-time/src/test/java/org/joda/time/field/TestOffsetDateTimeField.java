...
public class TestOffsetDateTimeField { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.setUp();
        TB.test_constructor1();
        TB.tearDown();
        TB.setUp();
        TB.test_constructor2();
        TB.tearDown();
        TB.setUp();
        TB.test_getType();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_getAsText_long_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsText_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsText_RP_int_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsText_RP_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsText_int_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsShortText_long_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsShortText_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsShortText_RP_int_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsShortText_RP_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getAsShortText_int_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_add_long_int();
        TB.tearDown();
        TB.setUp();
        TB.test_add_long_long();
        TB.tearDown();
        TB.setUp();
        TB.test_add_RP_int_intarray_int();
        TB.tearDown();
        TB.setUp();
        TB.test_addWrapField_long_int();
        TB.tearDown();
        TB.setUp();
        TB.test_addWrapField_RP_int_intarray_int();
        TB.tearDown();
        TB.setUp();
        TB.test_getDifference_long_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getDifferenceAsLong_long_long();
        TB.tearDown();
        TB.setUp();
        TB.test_set_long_int();
        TB.tearDown();
        TB.setUp();
        TB.test_set_RP_int_intarray_int();
        TB.tearDown();
        TB.setUp();
        TB.test_set_long_String_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_set_long_String();
        TB.tearDown();
        TB.setUp();
        TB.test_set_RP_int_intarray_String_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_convertText();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_getLeapAmount_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getLeapDurationField();
        TB.tearDown();
        TB.setUp();
        TB.test_getMinimumValue();
        TB.tearDown();
        TB.setUp();
        TB.test_getMinimumValue_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getMinimumValue_RP();
        TB.tearDown();
        TB.setUp();
        TB.test_getMinimumValue_RP_intarray();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumValue();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumValue_long();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumValue_RP();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumValue_RP_intarray();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumTextLength_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_getMaximumShortTextLength_Locale();
        TB.tearDown();
        TB.setUp();
        TB.test_roundFloor_long();
        TB.tearDown();
        TB.setUp();
        TB.test_roundCeiling_long();
        TB.tearDown();
        TB.setUp();
        TB.test_roundHalfFloor_long();
        TB.tearDown();
        TB.setUp();
        TB.test_roundHalfCeiling_long();
        TB.tearDown();
        TB.setUp();
        TB.test_roundHalfEven_long();
        TB.tearDown();
        TB.setUp();
        TB.test_remainder_long();
        TB.tearDown();
