...
public class TestDateTimeFormatterBuilder { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_canBuildFormatter();
        TB.tearDown();
        TB.setUp();
        TB.test_canBuildPrinter();
        TB.tearDown();
        TB.setUp();
        TB.test_canBuildParser();
        TB.tearDown();
        TB.setUp();
        TB.test_append_Formatter();
        TB.tearDown();
        TB.setUp();
        TB.test_append_Printer();
        TB.tearDown();
        TB.setUp();
        TB.test_append_nullPrinter();
        TB.tearDown();
        TB.setUp();
        TB.test_append_Parser();
        TB.tearDown();
        TB.setUp();
        TB.test_append_nullParser();
        TB.tearDown();
        TB.setUp();
        TB.test_append_Printer_nullParser();
        TB.tearDown();
        TB.setUp();
        TB.test_append_nullPrinter_Parser();
        TB.tearDown();
        TB.setUp();
        TB.test_appendOptional_Parser();
        TB.tearDown();
        TB.setUp();
        TB.test_appendOptional_nullParser();
        TB.tearDown();
        TB.setUp();
        TB.test_appendFixedDecimal();
        TB.tearDown();
        TB.setUp();
        TB.test_appendFixedSignedDecimal();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_parse();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min1max1();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min1max2();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min1max3();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min2max2();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min2max3();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_print_min3max3();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_invalidText();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneOffset_zeroMinInvalid();
        TB.tearDown();
        TB.setUp();
        TB.test_appendTimeZoneId();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneTokyo();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneParis();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneDawson();
        TB.tearDown();  // clashes with shorter Dawson
        TB.setUp();
        TB.test_printParseZoneDawson_suffix();
        TB.tearDown();  // clashes with shorter Dawson
        TB.setUp();
        TB.test_printParseZoneDawsonCreek();
        TB.tearDown();  // clashes with shorter Dawson
        TB.setUp();
        TB.test_printParseZoneDawsonCreek_suffix();
        TB.tearDown();  // clashes with shorter Dawson
        TB.setUp();
        TB.test_printParseZoneEtcGMT();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneEtcGMT_suffix();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneGMT();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneGMT_suffix();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneEtcGMT1();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneEtcGMT1_suffix();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneEtcGMT10();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneEtcGMT10_suffix();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneMET();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneMET_suffix();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseZoneBahiaBanderas();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseOffset();
        TB.tearDown();
        TB.setUp();
        TB.test_printParseOffsetAndZone();
        TB.tearDown();
        TB.setUp();
        TB.test_parseWrongOffset();
        TB.tearDown();
        TB.setUp();
        TB.test_parseWrongOffsetAndZone();
        TB.tearDown();
        TB.setUp();
        TB.test_localPrintParseZoneTokyo();
        TB.tearDown();
        TB.setUp();
        TB.test_localPrintParseOffset();
        TB.tearDown();
        TB.setUp();
        TB.test_localPrintParseOffsetAndZone();
        TB.tearDown();
        TB.setUp();
        TB.test_localParseWrongOffsetAndZone();
        TB.tearDown();
