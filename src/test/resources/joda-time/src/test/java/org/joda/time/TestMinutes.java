...
public class TestMinutes { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_minutes_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_minutesBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_minutesBetween_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_minutesIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardMinutesIn_RPeriod();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseMinutes_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
