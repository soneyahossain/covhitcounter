...
public class TestMonths { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_months_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RInstant_LocalDate_EndMonth();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RPartial_LocalDate();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RPartial_LocalDate_EndMonth();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RPartial_YearMonth();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsBetween_RPartial_MonthDay();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_monthsIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseMonths_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
