...
public class TestDays { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_days_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_daysBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_daysBetween_RPartial_LocalDate();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_daysBetween_RPartial_YearMonth();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_daysBetween_RPartial_MonthDay();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_daysIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardDaysIn_RPeriod();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseDays_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testMultipliedBy_int();
        TB.tearDown();
        TB.setUp();
        TB.testDividedBy_int();
        TB.tearDown();
        TB.setUp();
        TB.testNegated();
        TB.tearDown();
        TB.setUp();
        TB.testAddToLocalDate();
        TB.tearDown();
