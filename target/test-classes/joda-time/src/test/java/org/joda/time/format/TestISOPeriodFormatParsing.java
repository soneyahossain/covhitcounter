...
public class TestISOPeriodFormatParsing { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.setUp();
        TB.testParseStandard1();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard2();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard3();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard4();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard5();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard6();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard7();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard8();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard9();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard10();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandard11();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandardFail1();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandardFail2();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandardFail3();
        TB.tearDown();
        TB.setUp();
        TB.testParseStandardFail4();
        TB.tearDown();
