...
public class TestLenientChronology {//extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.test_setMonthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.test_setDayOfMonth();
        TB.tearDown();
        TB.setUp();
        TB.test_setHourOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testNearDstTransition();
        TB.tearDown();
        TB.setUp();
        TB.test_MockTurkIsCorrect();
        TB.tearDown();
        TB.setUp();
        TB.test_lenientChrononolgy_Chicago();
        TB.tearDown();
        TB.setUp();
        TB.test_lenientChrononolgy_Turk();
        TB.tearDown();
        TB.setUp();
        TB.test_strictChrononolgy_Chicago();
        TB.tearDown();
        TB.setUp();
        TB.test_isoChrononolgy_Chicago();
        TB.tearDown();
