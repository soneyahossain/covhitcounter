...
public class TestTimeOfDay_Constructors { //extends TestCase {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactoryMillisOfDay_long1();
        TB.tearDown();
        TB.setUp();
        TB.testFactoryMillisOfDay_long1_Chronology();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testConstructor2_Object_Chronology();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_int_int_Chronology();
        TB.tearDown();
        TB.setUp();
        TB.testConstructor_int_int_nullChronology();
        TB.tearDown();
        TB.setUp();
