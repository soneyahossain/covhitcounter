...
public class TestSeconds { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_seconds_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_secondsBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_secondsBetween_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_secondsIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardSecondsIn_RPeriod();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseSeconds_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
