...
//                return super.implies(domain, permission);
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testSystemMillisSecurity();
        TB.tearDown();
        TB.setUp();
        TB.testFixedMillis();
        TB.tearDown();
        TB.setUp();
        TB.testFixedMillisSecurity();
        TB.tearDown();
        TB.setUp();
        TB.testOffsetMillis();
        TB.tearDown();
        TB.setUp();
        TB.testOffsetMillisToZero();
        TB.tearDown();
        TB.setUp();
        TB.testOffsetMillisSecurity();
        TB.tearDown();
        TB.setUp();
        TB.testMillisProvider();
        TB.tearDown();
        TB.setUp();
        TB.testMillisProvider_null();
        TB.tearDown();
        TB.setUp();
        TB.testMillisProviderSecurity();
        TB.tearDown();
        TB.setUp();
        TB.testGetInstantMillis_RI();
        TB.tearDown();
        TB.setUp();
        TB.testGetInstantChronology_RI();
        TB.tearDown();
        TB.setUp();
        TB.testGetIntervalChronology_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testGetIntervalChronology_RI_RI();
        TB.tearDown();
        TB.setUp();
        TB.testGetReadableInterval_ReadableInterval();
        TB.tearDown();
        TB.setUp();
        TB.testGetChronology_Chronology();
        TB.tearDown();
        TB.setUp();
        TB.testGetZone_Zone();
        TB.tearDown();
        TB.setUp();
        TB.testGetPeriodType_PeriodType();
        TB.tearDown();
        TB.setUp();
        TB.testGetDurationMillis_RI();
        TB.tearDown();
        TB.setUp();
        TB.testIsContiguous_RP();
        TB.tearDown();
        TB.setUp();
        TB.testIsContiguous_RP_GJChronology();
        TB.tearDown();
        TB.setUp();
        TB.test_julianDay();
        TB.tearDown();
