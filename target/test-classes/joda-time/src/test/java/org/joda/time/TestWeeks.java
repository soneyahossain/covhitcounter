...
public class TestWeeks { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFactory_weeks_int();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_weeksBetween_RInstant();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_weeksBetween_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_weeksIn_RInterval();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_standardWeeksIn_RPeriod();
        TB.tearDown();
        TB.setUp();
        TB.testFactory_parseWeeks_String();
        TB.tearDown();
        TB.setUp();
        TB.testGetMethods();
        TB.tearDown();
