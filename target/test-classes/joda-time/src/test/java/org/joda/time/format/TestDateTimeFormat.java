...
//trace 1 tests---------------------------------------------------------------------------------------------------
        ...
        TB.tearDown();
        TB.setUp();
        TB.testFormat_centuryOfEra();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_yearOfEra();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_yearOfEra_twoDigit();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_yearOfEraParse();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_year();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_year_twoDigit();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_year_long();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_weekyear();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_weekyearOfEra_twoDigit();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_weekOfWeekyear();
        TB.tearDown();

//trace 2 tests---------------------------------------------------------------------------------------------------

        TB.setUp();
        TB.testFormat_dayOfWeek();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_dayOfWeekShortText();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_dayOfWeekText();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_dayOfYearText();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_monthOfYear();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_monthOfYearShortText();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_monthOfYearText();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_dayOfMonth();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_halfdayOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_hourOfHalfday();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_clockhourOfHalfday();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_hourOfDay();
        TB.tearDown();

//trace 3 tests---------------------------------------------------------------------------------------------------
        TB.setUp();
        TB.testFormat_clockhourOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_minute();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_second();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_fractionOfSecond();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_fractionOfSecondLong();
        TB.tearDown();
...
//trace 4 tests---------------------------------------------------------------------------------------------------
        TB.setUp();
        TB.testFormat_zoneAmount();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_zoneAmountColon();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_zoneAmountID();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_other();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_invalid();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_samples();
        TB.tearDown();
        TB.setUp();
        TB.testFormat_shortBasicParse();
        TB.tearDown();
        TB.setUp();
        TB.testParse_pivotYear();
        TB.tearDown();
        TB.setUp();
        TB.testParse_pivotYear_ignored4DigitYear();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanShort_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanShortLowerCase_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanShortUpperCase_UK();
        TB.tearDown();
        TB.setUp();
        TB.testParse_textMonthJanLong_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanLongLowerCase_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanLongUpperCase_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanShort_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthJanLong_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthApr_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthAtEnd_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthAtEnd_France_withSpecifiedDefault();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textMonthApr_Korean();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textHalfdayAM_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textHalfdayAM_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textEraAD_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textEraAD_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textEraBC_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textYear_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textYear_France();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textAdjoiningHelloWorld_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_textAdjoiningMonthDOW_UK();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_zoneId_noColon();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_zoneId_noColon_parseZ();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_zoneId_colon();
        TB.tearDown();
        TB.setUp();
        TB.testFormatParse_zoneId_colon_parseZ();
        TB.tearDown();
