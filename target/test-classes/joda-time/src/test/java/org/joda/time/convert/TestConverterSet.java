...
public class TestConverterSet {//extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testAddNullRemoved1();
        TB.tearDown();
        TB.setUp();
        TB.testAddNullRemoved2();
        TB.tearDown();
        TB.setUp();
        TB.testAddNullRemoved3();
        TB.tearDown();
        TB.setUp();
        TB.testRemoveNullRemoved1();
        TB.tearDown();
        TB.setUp();
        TB.testRemoveNullRemoved2();
        TB.tearDown();
        TB.setUp();
        TB.testRemoveBadIndex1();
        TB.tearDown();
        TB.setUp();
        TB.testRemoveBadIndex2();
        TB.tearDown();
    }
