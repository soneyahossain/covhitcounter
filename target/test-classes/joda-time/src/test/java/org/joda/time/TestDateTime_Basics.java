...
public class TestDateTime_Basics { //extends TestCase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testToDateTimeISO();
        TB.tearDown();
        //TB.setUp(); TB.testToDateTime_DateTimeZone(); TB.tearDown();
        TB.setUp();
        TB.testToDateTime_Chronology();
        TB.tearDown();
        TB.setUp();
        TB.testToMutableDateTime();
        TB.tearDown();
        TB.setUp();
        TB.testToMutableDateTimeISO();
        TB.tearDown();
        TB.setUp();
        TB.testToMutableDateTime_DateTimeZone();
        TB.tearDown();
        TB.setUp();
        TB.testToMutableDateTime_Chronology();
        TB.tearDown();
        TB.setUp();
        TB.testToDate();
        TB.tearDown();
        TB.setUp();
        TB.testToCalendar_Locale();
        TB.tearDown();
        TB.setUp();
        TB.testToGregorianCalendar();
        TB.tearDown();
        TB.setUp();
        TB.testToDateMidnight();
        TB.tearDown();
        TB.setUp();
        TB.testToYearMonthDay();
        TB.tearDown();
        TB.setUp();
        TB.testToTimeOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testToLocalDateTime();
        TB.tearDown();
        TB.setUp();
        TB.testToLocalDate();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testWithMillis_long();
        TB.tearDown();
        TB.setUp();
        TB.testWithChronology_Chronology();
        TB.tearDown();
        TB.setUp();
        TB.testWithZone_DateTimeZone();
        TB.tearDown();
        //TB.setUp(); TB.testWithZoneRetainFields_DateTimeZone(); TB.tearDown();
        TB.setUp();
        TB.testWithDate_int_int_int();
        TB.tearDown();
        TB.setUp();
        TB.testWithDate_int_int_int_toDST1();
        TB.tearDown();
        TB.setUp();
        TB.testWithDate_int_int_int_toDST2();
        TB.tearDown();
        TB.setUp();
        TB.testWithDate_int_int_int_affectedByDST();
        TB.tearDown();
        TB.setUp();
        TB.testWithDate_LocalDate();
        TB.tearDown();
        TB.setUp();
        TB.testWithTime_int_int_int_int();
        TB.tearDown();
        TB.setUp();
        TB.testWithTime_int_int_int_int_toDST();
        TB.tearDown();
        TB.setUp();
        TB.testWithTime_LocalTime();
        TB.tearDown();
        TB.setUp();
        TB.testWithTimeAtStartOfDay();
        TB.tearDown();
        TB.setUp();
        TB.testWithFields_RPartial();
        TB.tearDown();
        TB.setUp();
        TB.testWithField1();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testWithDurationAdded_long_int();
        TB.tearDown();
        TB.setUp();
        TB.testWithDurationAdded_RD_int();
        TB.tearDown();
        TB.setUp();
        TB.testWithDurationAdded_RP_int();
        TB.tearDown();
        TB.setUp();
        TB.testPlus_long();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPlusMonths_intMax();
        TB.tearDown();
        TB.setUp();
        TB.testPlusMonths_intMin();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testPlusHours_int();
        TB.tearDown();
        TB.setUp();
        TB.testPlusMinutes_int();
        TB.tearDown();
        TB.setUp();
        TB.testPlusSeconds_int();
        TB.tearDown();
        TB.setUp();
        TB.testPlusMillis_int();
        TB.tearDown();
        TB.setUp();
        TB.testMinus_long();
        TB.tearDown();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testMinusMonths_intMax();
        TB.tearDown();
        TB.setUp();
        TB.testMinusMonths_intMin();
        TB.tearDown();
        TB.setUp();
        ...
        TB.tearDown();
        TB.setUp();
        TB.testMinusHours_int();
        TB.tearDown();
        TB.setUp();
        TB.testMinusMinutes_int();
        TB.tearDown();
        TB.setUp();
        TB.testMinusSeconds_int();
        TB.tearDown();
        TB.setUp();
        TB.testMinusMillis_int();
        TB.tearDown();
        TB.setUp();
        TB.testProperty();
        TB.tearDown();
