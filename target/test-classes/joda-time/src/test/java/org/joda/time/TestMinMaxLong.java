...
public class TestMinMaxLong { //extends TestCase {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_max_math();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_max_fields();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_max_fieldsUTC();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_max_fieldsNewYork();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_max_long();
        TB.tearDown();
        TB.setUp();
        TB.testPrintParseMax();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_min();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_min_math();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_min_fields();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_min_long();
        TB.tearDown();
        TB.setUp();
        TB.testPrintParseMin();
        TB.tearDown();
        TB.setUp();
        TB.testDateTime_aroundZero();
        TB.tearDown();
    }
